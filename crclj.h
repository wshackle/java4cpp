...
namespace crclj {
 ...
 namespace crcl{
  ...
  namespace utils{
   ...
   class PoseToleranceChecker : public ::crclj::java::lang::Object {
    ...
    static jboolean isInTolerance(::crclj::crcl::base::VectorType  &vectorType_0,::crclj::crcl::base::VectorType  &vectorType_1,::crclj::java::math::BigDecimal  &bigDecimal_2,::crclj::crcl::base::AngleUnitEnumType  &angleUnitEnumType_3);
    ...
    static jboolean isInTolerance(::crclj::crcl::base::PoseType  &poseType_0,::crclj::crcl::base::PoseType  &poseType_1,::crclj::crcl::base::PoseToleranceType  &poseToleranceType_2,::crclj::crcl::base::AngleUnitEnumType  &angleUnitEnumType_3);
 ...
 namespace java{
  namespace lang{
   ...
   class Enum : public Object {
    ...
    virtual jboolean equals(Object  &object_0);
    jstring toString();
 ...
 namespace crcl{
  namespace utils{
   ...
   class SimRobotEnum : public ::crclj::java::lang::Enum {
       public:
 ...
 namespace javax{
  namespace swing{
   ...
   class JComponent : public ::crclj::java::awt::Container {
    ...
    virtual ::crclj::java::lang::Object getClientProperty(::crclj::java::lang::Object  &object_0);
    virtual void putClientProperty(::crclj::java::lang::Object  &object_0,::crclj::java::lang::Object  &object_1);
 ...
 namespace crcl{
  ...
  namespace utils{
   ...
   class SimServerInner : public ::crclj::java::lang::Object {
    ...
    ::crclj::crcl::base::AngleUnitEnumType getAngleType();
    void setAngleType(::crclj::crcl::base::AngleUnitEnumType  &angleUnitEnumType_0);
    ...
    void setLengthUnit(::crclj::crcl::base::LengthUnitEnumType  &lengthUnitEnumType_0);
 ...
 namespace crcl{
  ...
  namespace utils{
   ...
   class PendantClientInner : public ::crclj::java::lang::Object {
    ...
    void stopMotion(::crclj::crcl::base::StopConditionEnumType  &stopConditionEnumType_0);
