...
java -jar ../../../target/java4cpp-1.0-SNAPSHOT-jar-with-dependencies.jar  -p crcl -n crclj -j ${HOME}/crcl4java/crcl4java-utils/target/crcl4java-utils-1.0-SNAPSHOT-jar-with-dependencies.jar;
