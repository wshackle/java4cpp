...
if test ! -f ../../../target/java4cpp-1.4-SNAPSHOT-jar-with-dependencies.jar ; then
    ( set -x; cd ../../../ ; mvn package; );
fi

rm crclj*.cpp crclj*.h core core.[0-9]* hs_*.log *.o crclj_test 2>/dev/null 

java -jar ../../../target/java4cpp-1.4-SNAPSHOT-jar-with-dependencies.jar  --verbose -p crcl -n crclj -j ${HOME}/usnistgov/crcl/tools/java/crcl4java/crcl4java-utils/target/crcl4java-utils-1.4-SNAPSHOT-jar-with-dependencies.jar;
