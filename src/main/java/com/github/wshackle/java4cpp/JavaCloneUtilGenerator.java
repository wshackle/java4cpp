...
public class JavaCloneUtilGenerator {
    ...
    public void generateCloneUtil(
            String classname,
            File dir,
            List<Class> classes,
            Set<String> nocopyclassnamesSet,
            String logString) throws IOException {
        ...
        try (PrintWriter pw = new PrintWriter(f)) {
            ...
            pw.println();
            pw.println("/****************************************");
            pw.println("* This file was automatically generated by " + this.getClass() + " with protection domain= " + this.getClass().getProtectionDomain());
            pw.println("* dir=" + dir);
            ...
            while (nocopyClassNamesIterator.hasNext()) {
                ...
                pw.println("\t\t" + nocopyclasssname + ".class" + ((nocopyClassNamesIterator.hasNext()) ? "," : ""));
            }
            pw.println("\t\t));");
            pw.println();
                            ...
                            if (ltIndex > 0 && gtIndex > ltIndex + 1 && gtIndex < returnTypeName.length()) {
                                ...
                                if (componentClass.isInterface() || nocopyclassnamesSet.contains(componentTypeName)) {
                                    ...
                                    if (nocopyclassnamesSet.isEmpty()) {
                                        ...
                                        pw.println("            boolean skipCopy" + itname + " = noCopyClasses.contains(" + itname + "Next.getClass());");
